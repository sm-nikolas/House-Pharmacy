...
<html lang="pt-br">
    <head>
        ...
        <title>House Pharmacy - Sobre</title>
    ...
    <body id="fundoSobre">
     ...
     <nav class="navbar navbar-expand-lg navbar-light  bg-white fixed">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                <a class="nav-link" href="homepage.php">Página Principal<span class="sr-only"></span></a>
              </li>
      ...
      <div class="banner"> 
        <img src="img/slideCapa.jpg" class=" w-100 "/>
      </div>  
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 ">
            ...
            <div class="card-body c1 info">
              <h2 class="display-4 titulo1"> Propósito </h2>
              <br>
              <p class="lead">A missão da House Pharmacy é trazer faciliadade e cuidado para sua vida, podendo te ajudar
                                quando quiser e onde estiver.</p>
            </div>
          </div>
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 ">
              <div class="card-body c2 info">
                <h2 class="display-4 titulo1"> Valores </h2>
                <br>
                <p class="lead">Nossos valores são fortalecidos por 5 pilares:  equipe, dedicação, amizade, comprometimento e cuidado.</p>
              </div>
          </div>
        </div>
      </div>  
      ...
      <div class="container">
        <h2 class="display-3 titulo">Onde estamos?</h2>
        <div class="mapa">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-2">
                <h5>Sobre-nós</h5>
                <ul>
                    <li><a href="../paginas/sobre.php">Informações da Empresa</a></li>
                </ul>
              </div>
