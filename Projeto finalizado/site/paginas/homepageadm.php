              ...
              echo "<div class='col-xs-12 col-sm- 6 col-md-6 col-lg-4 col-xl-4'  id='cardPro'>";
                echo "<div class='cartao' style='width: 17rem;'><br>";
                  ...
                  echo "<div class='card-body'>";
                    ...
                    echo "<input type='submit' value='Editar' class='btn btn-success'/>";
                  echo "</div>";  
                echo "</div>";
              echo "</div>";
            }
        ...
        echo "<div class='col-xs-12 col-sm- 6 col-md-6 col-lg-4 col-xl-4'  id='cardPro'>";
          echo "<div class='cartao' style='width: 17rem;'><br>";
            ...
            echo "<div class='card-body'>";
              echo "<h5 class='h5'>".$aux["nomeProduto"]."</h5><br>";
              echo "<p class='card-text'>R$".$aux["preco"]."</p>";
              echo "<a href='editaProduto.php?codProduto".$aux["codProduto"]."'><input type='submit' value='Editar' class='btn btn-success'/></a>";
            echo "</div>";  
          echo "</div>";
        echo "</div>";
      }
