<?php
    ...
    $imgProduto  = $_FILES["imagem"];
    $dir = "imgCarregadas/"; 

 
    if(!empty($nomeProduto) && !empty($preco) && !empty($descricao) && !empty($estoque) && !empty($imgProduto)){


        move_uploaded_file($imgProduto["tmp_name"], "$dir/".$imgProduto["name"]);

        $sql = "INSERT INTO produto(nomeProduto, preco, descricao, estoque, imagem) VALUES (?,?,?,?,?)";
        $stmt = $conexao->prepare($sql);
        $stmt->bind_param("sssis",$nomeProduto,$preco,$descricao,$estoque,$imgProduto["name"]);
        if(!$stmt->execute()) {
?>                
            <!DOCTYPE html>
            <html lang="pt-br">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark fixed">
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="gerenciarInfo.php">Gerenciar Informações<span class="sr-only"></span></a>
                                </li>
                ...
                <div class="container">
                    <h3 id="erroCad" class="display-5">Erro no cadastramento do produto</h3>
                </div>
                ...
                <div class="container">
                    <div class="row">
                    <div class="col">
                        <form method="POST" action="passaProdutos.php">
                        <table class="table">
                            <tr>
                            ...
                            <td class="align-bottom">
                                <input type=text name="nomeProduto" size=50>
                            </td>
                            </tr>
                            <tr>
                            <td class="align-bottom">
                            ...
                            <td class="align-bottom">
                                <input type=text name="preco" onkeypress="return somente_numeros(this);" onKeyUp="mascaraMoeda(this, event)" size=50>
                            </td>
                            </tr>
                            <tr>
                            <td class="align-bottom">
                            ...
                            <td class="align-bottom">
                                <input type="text" max="000" name="estoque" onkeypress="return somente_numeros(this);" size=10 maxlength=3>
                            </td>
                            </tr>
                            <tr>  
                            <td class="align-bottom">
                            ...
                            <td class="align-bottom">
                            <input type="file" id="imagem" name="imgProduto" required>
                            </td>
                            </tr>
                            </table>
                            <hr>
